...
var tr46 = __webpack_require__(373);
  ...
  */
   ...
   */
		...
		value: function openLogin() {
			this._initPaymentFrame().then(_VXPaySetLoginFlowMiddleware2.default).then(_VXPayShowLoginMiddleware2.default);
		}
	}, {
		key: 'openSignUp',
		value: function openSignUp() {
			this._initPaymentFrame().then(_VXPaySetLoginFlowMiddleware2.default).then(_VXPayShowSignUpMiddleware2.default);
		}
	}, {
		...
		value: function openAbo() {
			this._initPaymentFrame().then(_VXPaySetVipAboFlowMiddleware2.default).then(_VXPayShowAboMiddleware2.default);
		}
	}, {
		key: 'openSettings',
		...
		value: function limitPayment() {
			this._initPaymentFrame().then(_VXPaySetLimitFlowMiddleware2.default).then(_VXPayShowMiddleware2.default);
		}
	}, {
		key: 'changeCard',
		value: function changeCard() {
			this._initPaymentFrame().then(_VXPaySetChangeCardMiddleware2.default).then(_VXPayShowMiddleware2.default);
		}
	}, {
		key: 'vipAboTrial',
		value: function vipAboTrial() {
			this._initPaymentFrame().then(_VXPaySetVIpAboTrialMiddleware2.default).then(_VXPayShowMiddleware2.default);
		}
	}, {
		key: 'premiumAbo',
		value: function premiumAbo() {
			this._initPaymentFrame().then(_VXPaySetVipAboFlowMiddleware2.default).then(_VXPayShowMiddleware2.default);
		}
	}, {
		key: 'openAVS',
		value: function openAVS() {
			this._initPaymentFrame().then(_VXPaySetAVSFlowMiddleware2.default).then(_VXPayShowAVSMiddleware2.default);
		}
	}, {
		key: 'openPromoCode',
		value: function openPromoCode() {
			this._initPaymentFrame().then(_VXPaySetPromoCodeMiddleware2.default).then(_VXPayShowPromoCodeMiddleware2.default);
		}
	}, {
		key: 'openScratchCard',
		value: function openScratchCard() {
			this._initPaymentFrame().then(_VXPaySetScratchCardMiddleware2.default).then(_VXPayShowPromoCodeMiddleware2.default);
		}
	}, {
		key: 'openOneClick',
		value: function openOneClick() {
			this._initPaymentFrame().then(_VXPaySetOneClickMiddleware2.default).then(_VXPayShowMiddleware2.default);
		}
	}, {
		key: 'openAutoReCharge',
		value: function openAutoReCharge() {
			this._initPaymentFrame().then(_VXPaySetAutoRechargeMiddleware2.default).then(_VXPayShowMiddleware2.default);
		}
...
exports.URL = __webpack_require__(368).interface;
...
var Impl = __webpack_require__(376);
...
var _VXPayHelperHooksConfig = __webpack_require__(391);
...
var _VXPayBalanceMessage = __webpack_require__(389);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(249));
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(366)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
var _VXPayNotifications = __webpack_require__(427);
...
var Impl = __webpack_require__(372);
...
var punycode = __webpack_require__(151);
var regexes = __webpack_require__(374);
var mappingTable = __webpack_require__(375);
...
var stableSortBy = __webpack_require__(377);
var urlencoded = __webpack_require__(70);
...
var _VXPayLoggedInMessage = __webpack_require__(380);
...
var _VXPayUser = __webpack_require__(386);
...
var _VXPayBalance = __webpack_require__(390);
...
var _VXPayPaymentType = __webpack_require__(409);
...
var _VXPayIsLoggedInTriggerMiddleware = __webpack_require__(419);
...
var _VXPayIsLoggedInActionMessage = __webpack_require__(420);
...
var _VXPayGetAVSStatusMessage = __webpack_require__(425);
