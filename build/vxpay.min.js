...
var _VXPayHelperHooksConfig = __webpack_require__(381);
...
var _VXPayBalanceMessage = __webpack_require__(376);

var _VXPayBalanceMessage2 = _interopRequireDefault(_VXPayBalanceMessage);

var _VXPayActiveAbosMessage = __webpack_require__(378);

var _VXPayActiveAbosMessage2 = _interopRequireDefault(_VXPayActiveAbosMessage);

var _VXPayLoggedOutMessage = __webpack_require__(380);
...
var _VXPayHookRouter = __webpack_require__(153);
...
var _VXPayAdditionalOptionsMessage = __webpack_require__(154);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(72), __webpack_require__(358)(module)))
...
var _VXPay = __webpack_require__(364);
...
var _VXPayPaymentTab = __webpack_require__(155);
  ...
  */
   ...
   */
		...
		value: function openLogin() {
			...
			return new Promise(function (resolve, reject) {
				return _this3._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenLoginCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openSignUp() {
			...
			return new Promise(function (resolve, reject) {
				return _this4._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenSignUpCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openVoiceCall() {
			...
			return new Promise(function (resolve, reject) {
				_this5._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenVoiceCallCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openPayment() {
			...
			return new Promise(function (resolve, reject) {
				_this7._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenPaymentCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openAbo() {
			...
			return new Promise(function (resolve, reject) {
				_this8._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenAboCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openSettings() {
			...
			return new Promise(function (resolve, reject) {
				_this9._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenSettingsCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function resetPassword() {
			...
			return new Promise(function (resolve, reject) {
				_this10._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayResetPasswordCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function lostPassword() {
			...
			return new Promise(function (resolve, reject) {
				_this11._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayLostPasswordCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function isLoggedIn() {
			...
			return new Promise(function (resolve, reject) {
				_this12._initPaymentFrame().then(function (vxpay) {
   ...
   */
		...
		value: function getAVSStatus() {
			...
			return new Promise(function (resolve, reject) {
				return _this13._initPaymentFrame().then(function (vxpay) {
   ...
   */
		...
		value: function getBalance() {
			...
			return new Promise(function (resolve, reject) {
				_this14._initPaymentFrame().then(function (vxpay) {
   ...
   */
		...
		value: function getActiveAbos() {
			...
			return new Promise(function (resolve, reject) {
				_this15._initPaymentFrame().then(function (vxpay) {
   ...
   */
		...
		value: function logout() {
			...
			return new Promise(function (resolve, reject) {
				_this16._initPaymentFrame().then(function (vxpay) {
...
var _VXPayLoggedInMessage = __webpack_require__(367);
...
var _VXPayUser = __webpack_require__(373);
...
var _VXPayBalance = __webpack_require__(377);
...
var _VXPayAbo = __webpack_require__(379);
...
var _VXPaySetFlowMiddleware = __webpack_require__(33);
 ...
 * @constructor
 */
var VXPaySetPasswordLostMiddleware = function VXPaySetPasswordLostMiddleware(vxpay) {
	var href = vxpay.config.window.location.href,
	    newFlow = {
		flow: _VXPayFlow2.default.PASSWORD_LOST,
		pwdresetUserId: _VXPayUrlHelper2.default.getQueryParam('u', href),
		pwdresetUserName: _VXPayUrlHelper2.default.getQueryParam('tpLoginPwdLost', href),
		pwdresetEmail: _VXPayUrlHelper2.default.getQueryParam('tpEmailPwdLost', href)
	};
...
var _VXPayPaymentType = __webpack_require__(156);
...
var _VXPayIsLoggedInTriggerMiddleware = __webpack_require__(399);
...
var _VXPayIsLoggedInActionMessage = __webpack_require__(400);
...
var _VXPayGetAVSStatusMessage = __webpack_require__(405);
...
var _VXPayGetBalanceMessage = __webpack_require__(408);
...
var _VXPayGetActiveAbosMessage = __webpack_require__(411);
...
var _VXPayLogoutMessage = __webpack_require__(414);
...
var _VXPayPaymentRoutes = __webpack_require__(157);
...
var VXPayOpenVoiceCallCommand = function () {
   ...
   */
		value: function run(vxpay) {
			vxpay.paymentFrame.sendOptions(VXPayOpenVoiceCallCommand.PARAMS).sendAdditionalOptions(vxpay.config.getAdditionalOptions()).changeRoute(_VXPayPaymentRoutes2.default.PAYMENT).initSession();
 ...
 * @constructor
 */
var VXPayWhenFrameReady = function VXPayWhenFrameReady(vxpay) {
	return new Promise(function (resolve) {
		// do we have the token already?
		if (vxpay.state.isFrameReady) {
			...
			// otherwise - wait for it
			vxpay.hooks.onIframeReady(function (msg) {
				return resolve(vxpay);
			});
		}
...
exports.default = VXPayWhenFrameReady;
...
var VXPayOpenSettingsCommand = function () {
   ...
   */
		value: function run(vxpay) {
			vxpay.paymentFrame.sendOptions(VXPayOpenSettingsCommand.PARAMS).sendAdditionalOptions(vxpay.config.getAdditionalOptions()).changeRoute().initSession();
 ...
 * @constructor
 */
var VXPaySetPasswordResetMiddleware = function VXPaySetPasswordResetMiddleware(vxpay) {
	var href = vxpay.config.window.location.href,
	    newFlow = {
		flow: _VXPayFlow2.default.PASSWORD_LOST,
		pwdresetUserId: _VXPayUrlHelper2.default.getQueryParam('u', href),
		pwdresetUserName: _VXPayUrlHelper2.default.getQueryParam('tpLoginPwdLost', href),
		pwdresetKey: _VXPayUrlHelper2.default.getQueryParam('key', href)
	};
...
var VXPayResetPasswordCommand = function () {
   ...
   */
		value: function run(vxpay) {
			vxpay.paymentFrame.initSession().sendOptions(VXPayResetPasswordCommand.getParams(vxpay.config)).sendAdditionalOptions(vxpay.config.getAdditionalOptions()).changeRoute();
...
var VXPayLostPasswordCommand = function () {
   ...
   */
		value: function run(vxpay) {
			vxpay.paymentFrame.initSession().sendOptions(VXPayLostPasswordCommand.getParams(vxpay.config)).sendAdditionalOptions(vxpay.config.getAdditionalOptions()).changeRoute();
