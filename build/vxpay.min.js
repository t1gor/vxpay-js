...
var _VXPayBalanceMessage = __webpack_require__(425);
...
var _VXPayCurrency = __webpack_require__(426);
			...
			return new Promise(function (resolve, reject) {
				_this8._initPaymentFrame().then(function (vxpay) {
					if (!vxpay.hooks.hasOnBalance(resolve)) {
						vxpay.hooks.onBalance(function (msg) {
							return resolve(msg);
						});
					}
					...
					if (vxpay.config.token === '') {
						vxpay.hooks.onTransferToken(function (msg) {
							return vxpay.paymentFrame.postMessage(new _VXPayGetBalanceMessage2.default());
						});
					} else {
						vxpay.paymentFrame.postMessage(new _VXPayGetBalanceMessage2.default());
					}
...
var _VXPayBalance = __webpack_require__(427);
