  ...
  */
   ...
   */
		...
		value: function getValidTypes() {
			return [VXPayMessage.TYPE_INIT_SESSION, VXPayMessage.TYPE_UPDATE_PARAMS, VXPayMessage.TYPE_IS_VISIBLE, VXPayMessage.TYPE_ADDITIONAL_INFO, VXPayMessage.TYPE_CHANGE_ROUTE, VXPayMessage.TYPE_ACTION_GET_ACTIVE_ABOS, VXPayMessage.TYPE_ACTION_LOGOUT, VXPayMessage.TYPE_ACTION_GET_AVS_STATUS, VXPayMessage.TYPE_HOOK, VXPayMessage.TYPE_SCROLL_TO, VXPayMessage.TYPE_SUCCESS, VXPayMessage.TYPE_IFRAME_CLOSE, VXPayMessage.TYPE_IFRAME_READY, VXPayMessage.TYPE_VIEW_READY, VXPayMessage.TYPE_TRANSFER_TOKEN, VXPayMessage.TYPE_CONTENT_LOADED, VXPayMessage.TYPE_HAS_LOGIN_COOKIE];
		}
	}]);
...
var tr46 = __webpack_require__(372);

var infra = __webpack_require__(151);
...
var _VXPayDomHelper = __webpack_require__(153);
...
var _VXPayHooksConfig2 = __webpack_require__(110);
...
var _whatwgUrl = __webpack_require__(146);
...
var _VXPayFlowChangedMessage = __webpack_require__(154);
...
exports.URL = __webpack_require__(367).interface;
exports.URLSearchParams = __webpack_require__(152).interface;
...
;(function (root) {
  ...
  */
   ...
   */
	...
	// like the following:
	if ("function" == 'function' && _typeof(__webpack_require__(150)) == 'object' && __webpack_require__(150)) {
...
var Impl = __webpack_require__(375);
...
var _VXPayHasSessionCookieMessage = __webpack_require__(156);

var _VXPayHasSessionCookieMessage2 = _interopRequireDefault(_VXPayHasSessionCookieMessage);

var _VXPayMessageFactory = __webpack_require__(157);
...
var _VXPayHelperHooksConfig = __webpack_require__(388);

var _VXPayHelperHooksConfig2 = _interopRequireDefault(_VXPayHelperHooksConfig);

var _VXPayHooksConfig = __webpack_require__(110);
...
var _VXPayHookRouter = __webpack_require__(160);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(247));
...
exports.VXPayFlow = exports.VXPayPaymentHooksConfig = exports.VXPayModalConfig = exports.VXPayNotifications = exports.VXPayLanguage = exports.VXPayEnvironment = exports.VXPayConfig = exports.VXPay = undefined;

var _VXPay = __webpack_require__(366);

var _VXPay2 = _interopRequireDefault(_VXPay);

var _VXPayConfig = __webpack_require__(145);
...
var _VXPayNotifications = __webpack_require__(421);
				...
				return _this7._initPaymentFrame().then(function (vxpay) {
					...
					if (vxpay.config.token === '') {
						vxpay.hooks.onTransferToken(function (msg) {
							...
							vxpay.paymentFrame.postMessage(new _VXPayGetAVSStatusMessage2.default());
						});
					} else {
						// trigger post message
						vxpay.paymentFrame.postMessage(new _VXPayGetAVSStatusMessage2.default());
...
var Impl = __webpack_require__(371);
...
var URLSearchParams = __webpack_require__(152);
...
var punycode = __webpack_require__(149);
var regexes = __webpack_require__(373);
var mappingTable = __webpack_require__(374);
...
var stableSortBy = __webpack_require__(376);
var urlencoded = __webpack_require__(70);
...
var _VXPayLoggedInMessage = __webpack_require__(379);
...
var _VXPayUser = __webpack_require__(385);
...
var _VXPayPaymentType = __webpack_require__(406);
...
var _VXPayIsLoggedInTriggerMiddleware = __webpack_require__(416);
...
var _VXPayIsLoggedInActionMessage = __webpack_require__(417);
