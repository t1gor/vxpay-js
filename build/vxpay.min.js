...
var tr46 = __webpack_require__(363);

var infra = __webpack_require__(146);
...
var _VXPayDomHelper = __webpack_require__(148);
...
var _VXPayHooksConfig2 = __webpack_require__(392);
...
var _VXPayFlow = __webpack_require__(48);

var _VXPayFlow2 = _interopRequireDefault(_VXPayFlow);

var _whatwgUrl = __webpack_require__(141);
...
var _VXPayIframe = __webpack_require__(68);
...
var _VXPayUrlHelper = __webpack_require__(368);

var _VXPayUrlHelper2 = _interopRequireDefault(_VXPayUrlHelper);

var _VXPayFlowChangedMessage = __webpack_require__(149);
...
exports.URL = __webpack_require__(358).interface;
exports.URLSearchParams = __webpack_require__(147).interface;
...
exports.percentDecode = __webpack_require__(67).percentDecode;
...
;(function (root) {
  ...
  */
   ...
   */
	...
	// like the following:
	if ("function" == 'function' && _typeof(__webpack_require__(145)) == 'object' && __webpack_require__(145)) {
...
var conversions = __webpack_require__(142);
...
var _VXPaySuccessMessage = __webpack_require__(378);
...
var _VXPayMessageFactory = __webpack_require__(151);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(13)(proto, TO_PRIMITIVE, __webpack_require__(238));
...
var _VXPay = __webpack_require__(357);
...
var _VXPayNotifications = __webpack_require__(390);
...
var VXPay = function () {
  ...
  */
   ...
   */
		...
		value: function openSignupOrLogin() {
			...
			this._initHelperFrame().then(function (vxpay) {
				...
				return message.hasCookie ? that.openLogin() : that.openSignup();
			});
		}
	}, {
		key: 'openPayment',
		value: function openPayment() {
			this._initPaymentFrame().then(_VXPaySetMoneyChargeMiddleware2.default).then(_VXPayShowSignUpMiddleware2.default);
		}
	}, {
		key: 'openAbo',
		...
		value: function limitPayment() {
			this._initPaymentFrame().then(_VXPaySetLimitFlowMiddleware2.default);
		}
	}, {
		key: 'changeCard',
   ...
   */
		...
		key: 'skipViewReady',
		get: function get() {
			return this._skipViewReady;
		},
		set: function set(value) {
			this._skipViewReady = value;
		}
	}]);
...
var Impl = __webpack_require__(362);
...
var urlencoded = __webpack_require__(67);
var URLSearchParams = __webpack_require__(147);
...
var punycode = __webpack_require__(144);
var regexes = __webpack_require__(364);
var mappingTable = __webpack_require__(365);
...
var stableSortBy = __webpack_require__(367);
var urlencoded = __webpack_require__(67);
...
var _VXPayIframe2 = __webpack_require__(68);
...
var _VXPayHooksConfig = __webpack_require__(392);
...
var _VXPayLoggedInMessage = __webpack_require__(373);
...
var _VXPayHookRouter = __webpack_require__(152);
