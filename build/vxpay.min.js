...
var tr46 = __webpack_require__(360);
...
var VXPayIframe = function (_VXPayEventListener) {
  ...
  */
	function VXPayIframe(document, url, id) {
		...
		// add to document
		document.getElementsByTagName('body').item(0).appendChild(_this._frame);
		return _this;
	}
...
var _VXPayUrlHelper = __webpack_require__(365);
...
exports.URL = __webpack_require__(355).interface;
...
var _VXPayMessage2 = __webpack_require__(21);
...
var _VXPayMessage = __webpack_require__(21);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(235));
...
var _VXPay = __webpack_require__(354);
...
var _VXPayNotifications = __webpack_require__(379);
...
var _VXPayPaymentHooksConfig = __webpack_require__(149);

var _VXPayPaymentHooksConfig2 = _interopRequireDefault(_VXPayPaymentHooksConfig);

var _es6ObjectAssign = __webpack_require__(380);
...
var _VXPayLogger = __webpack_require__(366);

var _VXPayLogger2 = _interopRequireDefault(_VXPayLogger);

var _VXPayHelperFrame = __webpack_require__(367);

var _VXPayHelperFrame2 = _interopRequireDefault(_VXPayHelperFrame);

var _VXPayPaymentFrame = __webpack_require__(374);
  ...
  */
	...
	_createClass(VXPay, [{
		...
		value: function _initHelperFrame() {
			...
			this._helperFrame.getLoginCookie().then(function (msg) {
				console.log(msg);
			});
...
var Impl = __webpack_require__(359);
...
var punycode = __webpack_require__(141);
var regexes = __webpack_require__(361);
var mappingTable = __webpack_require__(362);
...
var stableSortBy = __webpack_require__(364);
var urlencoded = __webpack_require__(67);
...
var VXPayHelperFrame = function (_VXPayIframe) {
  ...
  */
	function VXPayHelperFrame(document, url, id) {
		var style = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : { display: 'none' };
...
var _VXPayFlowChangedMessage = __webpack_require__(370);
