...
var tr46 = __webpack_require__(364);

var infra = __webpack_require__(147);
...
var VXPayFlow = function () {
   ...
   */
		value: function getAllowed() {
			return [VXPayFlow.AVS, VXPayFlow.LIMIT, VXPayFlow.LOGIN, VXPayFlow.MONEY_CHARGE, VXPayFlow.OP_COMPENSATION, VXPayFlow.PASSWORD_RESET, VXPayFlow.PROMOCODE, VXPayFlow.SCRATCH_CARD, VXPayFlow.TRIAL_VIP_ABO, VXPayFlow.VIP_ABO, VXPayFlow.VXTV_ABO, VXPayFlow.SETTINGS];
		}
...
var _VXPayDomHelper = __webpack_require__(149);
...
var _VXPayFlow = __webpack_require__(33);

var _VXPayFlow2 = _interopRequireDefault(_VXPayFlow);

var _whatwgUrl = __webpack_require__(142);
...
var _VXPayIframe = __webpack_require__(53);
...
var _VXPayUrlHelper = __webpack_require__(369);

var _VXPayUrlHelper2 = _interopRequireDefault(_VXPayUrlHelper);

var _VXPayFlowChangedMessage = __webpack_require__(150);
...
exports.URL = __webpack_require__(359).interface;
exports.URLSearchParams = __webpack_require__(148).interface;

exports.parseURL = __webpack_require__(28).parseURL;
exports.basicURLParse = __webpack_require__(28).basicURLParse;
exports.serializeURL = __webpack_require__(28).serializeURL;
exports.serializeHost = __webpack_require__(28).serializeHost;
exports.serializeInteger = __webpack_require__(28).serializeInteger;
exports.serializeURLOrigin = __webpack_require__(28).serializeURLOrigin;
exports.setTheUsername = __webpack_require__(28).setTheUsername;
exports.setThePassword = __webpack_require__(28).setThePassword;
exports.cannotHaveAUsernamePasswordPort = __webpack_require__(28).cannotHaveAUsernamePasswordPort;
...
;(function (root) {
  ...
  */
   ...
   */
	...
	// like the following:
	if ("function" == 'function' && _typeof(__webpack_require__(146)) == 'object' && __webpack_require__(146)) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(99)(module), __webpack_require__(49)))
...
var Impl = __webpack_require__(367);
...
var _VXPaySuccessMessage = __webpack_require__(379);
...
var _VXPayMessageFactory = __webpack_require__(152);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(49), __webpack_require__(99)(module)))
...
var _VXPayConfig = __webpack_require__(141);
...
var _VXPayNotifications = __webpack_require__(396);
...
var _VXPaySetPasswordResetMiddleware = __webpack_require__(397);

var _VXPaySetPasswordResetMiddleware2 = _interopRequireDefault(_VXPaySetPasswordResetMiddleware);

var _VXPaySetPasswordLostFlowMiddleware = __webpack_require__(398);
  ...
  */
	...
	_createClass(VXPay, [{
		...
		value: function _initHelperFrame() {
			...
			return new Promise(function (resolve) {
				...
				if (typeof _this._helperFrame !== 'undefined') {
					return resolve(_this);
				}

				_this._helperFrame = new _VXPayHelperFrame2.default(_this._window.document, 'https://www.visit-x.net/VXPAY-V' + _this._apiVersion + '/helper', 'vx-helper-frame-payment');

				if (_this.config.logging) {
					_this._helperFrame.hooks.onAny(function (msg) {
						return _this.logger.log('<-- []', msg);
					}).onBeforeSend(function (msg) {
						return _this.logger.log('--> []', msg);
					});
				}

				_this._helperFrame.triggerLoad();
				return resolve(_this);
			});
		}
   ...
   */
		value: function _initPaymentFrame() {
			...
			return new Promise(function (resolve) {
				// check already initialized
				if (typeof _this2._paymentFrame !== 'undefined') {
					return resolve(_this2);
				}

				if (_this2._config.enableTab) {
					_this2._paymentFrame = new _VXPayPaymentTab2.default(_this2._window.document, _this2._config.getPaymentFrameUrl());
				} else {
					_this2._paymentFrame = new _VXPayPaymentFrame2.default(_this2._window.document, _this2._config.getPaymentFrameUrl(), 'vx-payment-frame-payment');
				}

				// do we need logging?
				if (_this2.config.logging) {
					_this2._paymentFrame.hooks.onAny(function (msg) {
						return _this2.logger.log('<-- []', msg);
					}).onBeforeSend(function (msg) {
						return _this2.logger.log('--> []', msg);
					});
				}

				if (!_this2._paymentFrame.loaded) {
					// set resolve hook
					_this2._paymentFrame.hooks.onFlowChange(_this2.config.updateFlow.bind(_this2._config)).onViewReady(_this2._paymentFrame.setVisible.bind(_this2._paymentFrame)).onContentLoaded(function (msg) {
						return resolve(_this2);
					}).onClose(function (msg) {
						return _this2._paymentFrame.hide();
					}).onSuccess(function (msg) {
						return _this2._paymentFrame.hide();
					});

					_this2._paymentFrame.triggerLoad();
				}
			});
		}
	}, {
		...
		value: function openSignupOrLogin() {
			...
			this._initHelperFrame().then(function (vxpay) {
				return vxpay._helperFrame.getLoginCookie();
			}).then(function (message) {
				return message.hasCookie ? _this3.openLogin() : _this3.openSignup();
			});
		}
	}, {
		key: 'openPayment',
		...
		value: function resetPassword() {
			...
			this._initPaymentFrame().then(function (vxpay) {
...
var Impl = __webpack_require__(363);
...
var usm = __webpack_require__(28);
var urlencoded = __webpack_require__(68);
var URLSearchParams = __webpack_require__(148);
...
var punycode = __webpack_require__(145);
var regexes = __webpack_require__(365);
var mappingTable = __webpack_require__(366);
...
var stableSortBy = __webpack_require__(368);
var urlencoded = __webpack_require__(68);
...
var _VXPayIframe2 = __webpack_require__(53);
...
var _VXPayHelperHooksConfig = __webpack_require__(380);
...
var VXPayHelperFrame = function (_VXPayIframe) {
  ...
  * @param {CSSStyleDeclaration} style
  */
	function VXPayHelperFrame(document, url, id) {
...
var _VXPayLoggedInMessage = __webpack_require__(374);
...
var VXPayPaymentFrame = function (_VXPayIframe) {
  ...
  */
   ...
   */
		...
		value: function getDefaultStyles(document) {
			var userAgent = new _VXPayUserAgentHelper2.default(document.defaultView.navigator.userAgent),
			...
			if (_VXPayDomHelper2.default.isStyleAttributeSuppored(bodyElement, 'maxHeight', '100vh')) {
...
var VXPayPaymentTab = function () {
  ...
  * @param {String} url
  */
	function VXPayPaymentTab(document, url) {
   ...
   */
		...
		value: function getNewTab(document, url) {
			...
			return new Promise(function (resolve) {
				...
				_this2._window = document.defaultView.open(url, 'vxpay');
...
var VXPaySetLoginFlowMiddleware = function VXPaySetLoginFlowMiddleware(vxpay) {
	...
	if (vxpay.config.flow === _VXPayFlow2.default.LOGIN) {
		return vxpay;
	}

	var newFlow = {
		flow: _VXPayFlow2.default.LOGIN
	};
...
var VXPaySetMoneyChargeMiddleware = function VXPaySetMoneyChargeMiddleware(vxpay) {
	// check not already same
	if (vxpay.config.flow === _VXPayFlow2.default.MONEY_CHARGE) {
		return vxpay;
	}
...
var VXPaySetVipAboFlowMiddleware = function VXPaySetVipAboFlowMiddleware(vxpay) {
	// check not already same
	if (vxpay.config.flow === _VXPayFlow2.default.VIP_ABO) {
		return vxpay;
	}

	var newFlow = {
		flow: _VXPayFlow2.default.VIP_ABO
	};
...
var VXPaySetPasswordResetMiddleware = function VXPaySetPasswordResetMiddleware(vxpay, window) {
	var newFlow = {
		...
		pwdresetUserId: _VXPayUrlHelper2.default.getQueryParam('u', window.location),
		pwdresetUserName: _VXPayUrlHelper2.default.getQueryParam('tpLoginPwdLost', window.location),
		pwdresetKey: _VXPayUrlHelper2.default.getQueryParam('key', window.location)
	};
...
var VXPaySetPasswordLostMiddleware = function VXPaySetPasswordLostMiddleware(vxpay, window) {
	var newFlow = {
		...
		pwdresetUserId: _VXPayUrlHelper2.default.getQueryParam('u', window.location),
		pwdresetUserName: _VXPayUrlHelper2.default.getQueryParam('tpLoginPwdLost', window.location),
		pwdresetEmail: _VXPayUrlHelper2.default.getQueryParam('tpEmailPwdLost', window.location)
	};
