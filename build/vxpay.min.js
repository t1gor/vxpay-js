...
var tr46 = __webpack_require__(371);
...
var _VXPayMessage2 = __webpack_require__(11);
  ...
  */
   ...
   */
		...
		value: function trigger(hook) {
			...
			// mark iframe as ready after at least one event
			if (hook === VXPayPaymentHooksConfig.ON_IFRAME_READY) {
				this._iframeReady = true;
			}

			return _get(VXPayPaymentHooksConfig.prototype.__proto__ || Object.getPrototypeOf(VXPayPaymentHooksConfig.prototype), 'trigger', this).call(this, hook, callbackArguments);
		}
	}]);
...
var ieee754 = __webpack_require__(368);
...
var _VXPayIframe = __webpack_require__(50);
...
exports.URL = __webpack_require__(366).interface;
...
var _VXPayIframe2 = __webpack_require__(50);
...
var _VXPayHelperHooksConfig = __webpack_require__(386);
...
var _VXPayMessage = __webpack_require__(11);
...
var _VXPaySuccessMessage = __webpack_require__(383);

var _VXPaySuccessMessage2 = _interopRequireDefault(_VXPaySuccessMessage);

var _VXPayIsLoggedInResponseMessage = __webpack_require__(385);
...
var _VXPayHookRouter = __webpack_require__(159);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(246));
...
var _VXPay = __webpack_require__(365);
...
var _VXPayNotifications = __webpack_require__(414);
...
var Impl = __webpack_require__(370);
...
var punycode = __webpack_require__(149);
var regexes = __webpack_require__(372);
var mappingTable = __webpack_require__(373);
...
var stableSortBy = __webpack_require__(375);
var urlencoded = __webpack_require__(70);
...
var _VXPayLoggedInMessage = __webpack_require__(378);
...
var _VXPayUser = __webpack_require__(384);
...
var _VXPaySetFlowMiddleware = __webpack_require__(32);
...
var _VXPayPaymentType = __webpack_require__(404);
...
var _VXPayIsLoggedInActionMessage = __webpack_require__(413);
...
var _VXPayIsLoggedInTriggerMiddleware = __webpack_require__(415);
...
var VXPayListenOrCallLoggedInMiddleware = function VXPayListenOrCallLoggedInMiddleware(vxpay, resolve, reject) {
	...
	if (vxpay.config.token === '') {
		console.log('Set up onTransferToken ...');
	...
	console.log('Calling VXPayIsLoggedInTriggerMiddleware directly ...');
