...
var tr46 = __webpack_require__(361);

var infra = __webpack_require__(143);
...
var _VXPayLanguage = __webpack_require__(97);

var _VXPayLanguage2 = _interopRequireDefault(_VXPayLanguage);

var _VXPayEnvironment = __webpack_require__(96);
...
var _whatwgUrl = __webpack_require__(138);

var _VXPayModalConfig = __webpack_require__(100);
...
var _VXPayValidator = __webpack_require__(98);
...
var _VXPayEventListener2 = __webpack_require__(102);

var _VXPayEventListener3 = _interopRequireDefault(_VXPayEventListener2);

var _VXPayDomHelper = __webpack_require__(145);
...
var _VXPayIframe = __webpack_require__(101);
...
var _VXPayUrlHelper = __webpack_require__(366);
...
exports.URL = __webpack_require__(356).interface;
exports.URLSearchParams = __webpack_require__(144).interface;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(95)(module), __webpack_require__(48)))
...
var Impl = __webpack_require__(364);
...
var _VXPayMessage2 = __webpack_require__(15);
...
var _VXPayMessage = __webpack_require__(15);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(236));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(48), __webpack_require__(95)(module)))
...
var _VXPay = __webpack_require__(355);

var _VXPay2 = _interopRequireDefault(_VXPay);

var _VXPayConfig = __webpack_require__(137);
...
var _VXPayNotifications = __webpack_require__(381);
...
var _VXPayPaymentHooksConfig = __webpack_require__(150);

var _VXPayPaymentHooksConfig2 = _interopRequireDefault(_VXPayPaymentHooksConfig);

var _es6ObjectAssign = __webpack_require__(382);
...
var _VXPayLogger = __webpack_require__(367);

var _VXPayLogger2 = _interopRequireDefault(_VXPayLogger);

var _VXPayHelperFrame = __webpack_require__(368);

var _VXPayHelperFrame2 = _interopRequireDefault(_VXPayHelperFrame);

var _VXPayPaymentFrame = __webpack_require__(376);
   ...
   */
		...
		value: function _initPaymentFrame() {
			...
			return new Promise(function (resolve) {
				...
				var hide = _this._paymentFrame.hide.bind(_this._paymentFrame);

				// set resolve hook
				_this._paymentFrame.hooks.onContentLoaded(function () {
					return resolve(_this._paymentFrame);
				...
				if (_this.config.logging) {
					_this._paymentFrame.hooks.onAny(function (msg) {
						return _this.logger.log('Received from PaymentFrame:', msg);
					}).onBeforeSend(function (msg) {
						return _this.logger.log('Sending to PaymentFrame:', msg);
					});
				}
		...
		value: function openLogin() {
			this._initPaymentFrame().then(function (frame) {
				frame.hooks.onViewReady(function () {
					return frame.postMessage(new _VXPayIsVisibleMessage2.default());
				});
				return frame;
			}).then(function (frame) {
				return frame.sendOptions({ flow: _VXPayFlow2.default.LOGIN }).show(_VXPayFlow2.default.LOGIN);
			});
		}
	}, {
		key: 'openSignup',
		value: function openSignup() {
			this._initPaymentFrame().then(function (frame) {
				return frame.sendOptions({ flow: _VXPayFlow2.default.LOGIN }).show('signup');
			});
		}
	}, {
...
var Impl = __webpack_require__(360);
...
var URLSearchParams = __webpack_require__(144);
...
var punycode = __webpack_require__(141);
var regexes = __webpack_require__(362);
var mappingTable = __webpack_require__(363);
...
var stableSortBy = __webpack_require__(365);
var urlencoded = __webpack_require__(67);
...
var _VXPayIframe2 = __webpack_require__(101);
...
var _VXPayEventListener = __webpack_require__(102);
...
var _VXPayHookMessage = __webpack_require__(148);

var _VXPayHookMessage2 = _interopRequireDefault(_VXPayHookMessage);

var _VXPayFlowChangedMessage = __webpack_require__(371);
...
var _VXPayHookMessage2 = __webpack_require__(148);
...
var _VXPayUserAgentHelper = __webpack_require__(380);
  ...
  */
   ...
   */
		value: function startListening() {
			_VXPayEventListener2.default.addEvent(_VXPayIframe3.default.EVENT_MESSAGE, this._frame.ownerDocument.defaultView, this.routeHook.bind(this));
		}
   ...
   */
		...
		key: 'routeHook',
		value: function routeHook(event) {
			var message = _VXPayMessageFactory2.default.fromJson(event.data);

			// route any
			this._hooks.trigger(_VXPayPaymentHooksConfig2.default.ON_ANY, [message]);

			switch (message.type) {
				case _VXPayMessage2.default.TYPE_CONTENT_LOADED:
					return this._hooks.trigger(_VXPayPaymentHooksConfig2.default.ON_CONTENT_LOADED, [message]);

				case _VXPayMessage2.default.TYPE_VIEW_READY:
					return this._hooks.trigger(_VXPayPaymentHooksConfig2.default.ON_VIEW_READY, [message]);

				case _VXPayMessage2.default.TYPE_IFRAME_CLOSE:
					return this._hooks.trigger(_VXPayPaymentHooksConfig2.default.ON_CLOSE, [message]);

				case _VXPayMessage2.default.TYPE_SUCCESS:
					return this._hooks.trigger(_VXPayPaymentHooksConfig2.default.ON_SUCCESS, [message]);
			}
		}
...
var VXPayPaymentTab = function () {
  ...
  */
   ...
   */
		value: function startListening() {
			_VXPayEventListener2.default.addEvent(_VXPayIframe2.default.EVENT_MESSAGE, this._window, this.routeHook.bind(this));
		}
