...
var tr46 = __webpack_require__(362);

var infra = __webpack_require__(144);
...
var _VXPayDomHelper = __webpack_require__(146);
...
var VXPayPaymentHooksConfig = function () {
  ...
  */
   ...
   */
		...
		key: 'hasOnIframeReady',
		value: function hasOnIframeReady() {
   ...
   */
		...
		key: 'getOnIframeReady',
		value: function getOnIframeReady() {
   ...
   */
		...
		key: 'hasOnContentLoaded',
		value: function hasOnContentLoaded() {
   ...
   */
		...
		key: 'getOnContentLoaded',
		value: function getOnContentLoaded() {
...
var _whatwgUrl = __webpack_require__(139);
...
var _VXPayUrlHelper = __webpack_require__(367);
...
exports.URL = __webpack_require__(357).interface;
exports.URLSearchParams = __webpack_require__(145).interface;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(98)(module), __webpack_require__(49)))
...
var conversions = __webpack_require__(140);
...
var Impl = __webpack_require__(365);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(49), __webpack_require__(98)(module)))
...
var _VXPay = __webpack_require__(356);

var _VXPay2 = _interopRequireDefault(_VXPay);

var _VXPayConfig = __webpack_require__(138);
...
var _VXPayNotifications = __webpack_require__(389);
...
var _VXPayLogger = __webpack_require__(368);

var _VXPayLogger2 = _interopRequireDefault(_VXPayLogger);

var _VXPayHelperFrame = __webpack_require__(369);

var _VXPayHelperFrame2 = _interopRequireDefault(_VXPayHelperFrame);

var _VXPayPaymentFrame = __webpack_require__(378);

var _VXPayPaymentFrame2 = _interopRequireDefault(_VXPayPaymentFrame);

var _VXPayPaymentTab = __webpack_require__(383);

var _VXPayPaymentTab2 = _interopRequireDefault(_VXPayPaymentTab);

var _VXPaySetLoginFlowMiddleware = __webpack_require__(384);

var _VXPaySetLoginFlowMiddleware2 = _interopRequireDefault(_VXPaySetLoginFlowMiddleware);

var _VXPaySetVisibleOnViewReadyMiddleware = __webpack_require__(385);

var _VXPaySetVisibleOnViewReadyMiddleware2 = _interopRequireDefault(_VXPaySetVisibleOnViewReadyMiddleware);
  ...
  */
	...
	_createClass(VXPay, [{
		...
		value: function _initHelperFrame() {
			...
			this._helperFrame = new _VXPayHelperFrame2.default(this._window.document, 'https://www.visit-x.net/VXPAY-V' + this._apiVersion + '/helper', 'vx-helper-frame-payment');
   ...
   */
		value: function _initPaymentFrame() {
			...
			return new Promise(function (resolve) {
				// check already initialized
				if (_this.hasOwnProperty('_paymentFrame') && _this._paymentFrame.loaded) {
					resolve(_this);
				}

				if (_this._config.enableTab) {
					_this._paymentFrame = new _VXPayPaymentTab2.default(_this._window.document, _this._config.getPaymentFrameUrl());
				} else {
					_this._paymentFrame = new _VXPayPaymentFrame2.default(_this._window.document, _this._config.getPaymentFrameUrl(), 'vx-payment-frame-payment');
				}

				// set resolve hook
				_this._paymentFrame.hooks.onContentLoaded(function () {
					return resolve(_this);
				}).onClose(function (msg) {
					return _this._paymentFrame.hide();
				...
				if (_this.config.logging) {
					_this._paymentFrame.hooks.onAny(function (msg) {
				...
				_this._paymentFrame.triggerLoad();
			});
		}
	}, {
		key: 'openLogin',
		value: function openLogin() {
			this.config.flow = _VXPayFlow2.default.LOGIN;

			this._initPaymentFrame().then(_VXPaySetVisibleOnViewReadyMiddleware2.default).then(_VXPaySetLoginFlowMiddleware2.default).then(_VXPayShowLoginMiddleware2.default);
		}
	}, {
		key: 'openSignup',
		value: function openSignup() {
			this._initPaymentFrame().then(_VXPaySetVisibleOnViewReadyMiddleware2.default).then(_VXPaySetLoginFlowMiddleware2.default).then(_VXPayShowSignUpMiddleware2.default);
		}
	}, {
		...
		value: function openPayment() {
			this._initPaymentFrame().then(_VXPaySetVisibleOnViewReadyMiddleware2.default).then(_VXPaySetMoneyChargeMiddleware2.default)
			/** @todo change last step */
			.then(_VXPayShowSignUpMiddleware2.default);
		}
	}, {
		key: 'openAbo',
...
var Impl = __webpack_require__(361);
...
var URLSearchParams = __webpack_require__(145);
...
var punycode = __webpack_require__(142);
var regexes = __webpack_require__(363);
var mappingTable = __webpack_require__(364);
...
var stableSortBy = __webpack_require__(366);
var urlencoded = __webpack_require__(67);
...
var _VXPayHookMessage = __webpack_require__(149);

var _VXPayHookMessage2 = _interopRequireDefault(_VXPayHookMessage);

var _VXPayFlowChangedMessage = __webpack_require__(372);

var _VXPayFlowChangedMessage2 = _interopRequireDefault(_VXPayFlowChangedMessage);

var _VXPayLoggedInMessage = __webpack_require__(390);
...
var _VXPayHookMessage2 = __webpack_require__(149);
...
var _VXPayInitSessionMessage = __webpack_require__(379);

var _VXPayInitSessionMessage2 = _interopRequireDefault(_VXPayInitSessionMessage);

var _VXPayUpdateParamsMessage = __webpack_require__(380);

var _VXPayUpdateParamsMessage2 = _interopRequireDefault(_VXPayUpdateParamsMessage);

var _VXPayChangeRouteMessage = __webpack_require__(381);
 ...
 * @constructor
 */
var VXPaySetVisibleOnViewReadyMiddleware = function VXPaySetVisibleOnViewReadyMiddleware(vxpay) {
  vxpay.frame.hooks.onIframeReady(function () {
    return vxpay.frame.postMessage(new _VXPayIsVisibleMessage2.default());
  });
  return vxpay;
};

exports.default = VXPaySetVisibleOnViewReadyMiddleware;
