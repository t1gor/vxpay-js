...
var _VXPayDomHelper = __webpack_require__(142);
...
var _VXPayFlowChangedMessage = __webpack_require__(143);
...
var _VXPayAVSStatus = __webpack_require__(147);
...
var _VXPayHookRouter = __webpack_require__(149);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(14)(proto, TO_PRIMITIVE, __webpack_require__(236));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(71), __webpack_require__(351)(module)))
...
var _VXPayNotifications = __webpack_require__(420);
...
var _VXPayPaymentFrame = __webpack_require__(148);

var _VXPayPaymentFrame2 = _interopRequireDefault(_VXPayPaymentFrame);

var _VXPayPaymentTab = __webpack_require__(150);
  ...
  */
   ...
   */
		...
		value: function limitPayment() {
			...
			return new Promise(function (resolve, reject) {
				_this12._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenLimitedPaymentCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function vipAboTrial() {
			...
			return new Promise(function (resolve, reject) {
				_this13._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenVipAboTrialCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function premiumAbo() {
			...
			return new Promise(function (resolve, reject) {
				_this14._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenPremiumAboCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openAVS() {
			...
			return new Promise(function (resolve, reject) {
				_this15._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenAVSCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openPromoCode() {
			...
			return new Promise(function (resolve, reject) {
				_this16._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenPromoCodeCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openScratchCard() {
			...
			return new Promise(function (resolve, reject) {
				_this17._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenPromoCodeCommand2.default).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openOneClick() {
			...
			return new Promise(function (resolve, reject) {
				_this18._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenOneClickCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openAutoReCharge() {
			...
			return new Promise(function (resolve, reject) {
				_this19._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenAutoRechargeCommand2.default.run).then(resolve).catch(reject);
			});
		}
   ...
   */
		...
		value: function openBalance() {
			...
			return new Promise(function (resolve, reject) {
				_this20._initPaymentFrame().then(_VXPayWhenTokenTransferred2.default).then(_VXPayOpenOpenBalanceCommand2.default).then(resolve).catch(reject);
			});
		}
...
var _VXPayLoggedInMessage = __webpack_require__(360);
...
var _VXPayShowMiddleware = __webpack_require__(383);
...
var _VXPaySetFlowMiddleware = __webpack_require__(385);
...
var _VXPayIsLoggedInTriggerMiddleware = __webpack_require__(387);
...
var _VXPayIsLoggedInActionMessage = __webpack_require__(388);
...
var _VXPayGetAVSStatusMessage = __webpack_require__(391);
...
var _VXPayGetBalanceMessage = __webpack_require__(394);
...
var _VXPayGetActiveAbosMessage = __webpack_require__(397);
...
var _VXPayLogoutMessage = __webpack_require__(400);
...
var _VXPayPaymentRoutes = __webpack_require__(23);
...
var VXPayOpenLimitedPaymentCommand = function () {
   ...
   */
		value: function run(vxpay) {
			vxpay.paymentFrame.sendOptions(VXPayOpenLimitedPaymentCommand.PARAMS).sendAdditionalOptions(vxpay.config.getAdditionalOptions()).changeRoute(_VXPayPaymentRoutes2.default.PAYMENT).initSession();
...
var VXPayOpenOneClickCommand = function () {
   ...
   */
		value: function run(vxpay) {
			vxpay.paymentFrame.initSession().sendOptions(VXPayOpenOneClickCommand.PARAMS).sendAdditionalOptions(vxpay.config.getAdditionalOptions()).changeRoute();
...
var VXPayOpenAutoRechargeCommand = function () {
   ...
   */
		value: function run(vxpay) {
			vxpay.paymentFrame.initSession().sendOptions(VXPayOpenAutoRechargeCommand.PARAMS).sendAdditionalOptions(vxpay.config.getAdditionalOptions()).changeRoute();
